# Claude 国内保姆级使用教程（支持 Claude 3.7 Sonnet，无需翻墙）【6月持续更新】
...
[**Claude 中文版**](https://talk.lanjing.pro) 是由 Anthropic 开发的 Claude 3.7 Sonnet 模型的中文优化版本，专为中文用户提供更流畅、更精准的 AI对话体验。  
...
| **蓝鲸 AI**     | [https://talk.lanjing.pro](https://talk.lanjing.pro) | Claude 3.7     | 有       | 国内邮箱注册 | 高   | Claude 3.7，GPT-4o，实时语音对话 |
